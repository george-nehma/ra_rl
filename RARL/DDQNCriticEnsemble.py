...
Authors: George Nehma ( gnehma2020@my.fit.edu )
...
class CriticEnsemble(DDQN):
  ...
  def __init__(
    ...
    Args:
        ...
        numCritic (int): the number of critics in the ensemble
    ...
    """
    super(CriticEnsemble, self).__init__(CONFIG)
    ...
    self.numCritic = CONFIG.NUM_CRITICS
  ...
  def build_ensemble(self):
    """Builds an ensemble of critic networks
